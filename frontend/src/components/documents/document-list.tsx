...
const TYPE_COLORS: Record<string, string> = {
  ...
  CLOSEOUT:
    "bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-950/50 dark:text-gray-300 dark:border-gray-800",
};
...
const STATUS_CONFIG: Record<
  ...
  {
    color: string;
    icon: typeof CheckCircle2 | typeof Loader2 | typeof Clock;
  }
> = {
  UPLOADING: {
          ...
          {readyCount > 0 && (
            <Button
              ...
              onClick={() => {
                if (
                  confirm(
                    "Re-process all documents? This will re-extract text and regenerate search embeddings."
                  )
                ) {
              ...
              {[
                {
                  ...
                  desc: "PDF, DOCX, XLSX, images",
                },
                {
                  icon: Search,
                  title: "AI-powered search",
                  desc: "Ask questions about docs",
                },
                {
                  icon: CheckCircle2,
                  title: "Auto-processing",
                  desc: "Text extraction & indexing",
                },
              ].map((f) => (
                <div
                  key={f.title}
                      ...
                      <div className="flex justify-end gap-1">
                        ...
                        <button
                          onClick={() => {
                            if (
                              confirm(
                                "Delete this document? This will remove all extracted content and embeddings."
                              )
                            ) {
